...
import edu.coursera.algs41.OrderedMaxPriorityQueue
import spock.lang.Specification

class OrderedMaxPriorityQueueTest extends Specification {
    def 'new queue is empty'() {
        when:
        def queue = new OrderedMaxPriorityQueue<Integer>(10)
