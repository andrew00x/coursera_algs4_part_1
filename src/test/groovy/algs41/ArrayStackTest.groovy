...
import edu.coursera.algs41.ArrayStack
import spock.lang.Specification

class ArrayStackTest extends Specification {
    ...
    def 'stack created with array is not empty'() {
        when:
        def stack = new ArrayStack<Integer>([1, 2, 3] as Integer[])
    ...
    def 'stack created with iterable is not empty'() {
        when:
        def stack = new ArrayStack<Integer>([1, 2, 3])
